...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [187 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2501632, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 32479552; uint32_t buffer_offset
	}, ; 184: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 32650560; uint32_t buffer_offset
	}, ; 185: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2189824, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 32672096; uint32_t buffer_offset
	} ; 186: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 34861920, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [34861920 x i8] zeroinitializer, align 16
