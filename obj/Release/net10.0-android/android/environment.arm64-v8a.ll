...
@dso_apk_entries = dso_local local_unnamed_addr global [164 x %struct.DSOApkEntry] zeroinitializer, align 8
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [36 x i8] c"com.companyname.ultimatewalletfinal\00", align 1
...
@.DSOCacheEntry.12_name = private unnamed_addr constant [34 x i8] c"libaot-UltimateWalletFinal.dll.so\00", align 1
@.DSOCacheEntry.13_name = private unnamed_addr constant [40 x i8] c"libaot-BouncyCastle.Cryptography.dll.so\00", align 1
...
@.DSOCacheEntry.16_name = private unnamed_addr constant [30 x i8] c"libaot-Google.Protobuf.dll.so\00", align 1
@.DSOCacheEntry.17_name = private unnamed_addr constant [35 x i8] c"libaot-K4os.Compression.LZ4.dll.so\00", align 1
@.DSOCacheEntry.18_name = private unnamed_addr constant [43 x i8] c"libaot-K4os.Compression.LZ4.Streams.dll.so\00", align 1
@.DSOCacheEntry.19_name = private unnamed_addr constant [31 x i8] c"libaot-K4os.Hash.xxHash.dll.so\00", align 1
...
@.DSOCacheEntry.29_name = private unnamed_addr constant [60 x i8] c"libaot-Microsoft.Extensions.Diagnostics.Abstractions.dll.so\00", align 1
@.DSOCacheEntry.30_name = private unnamed_addr constant [62 x i8] c"libaot-Microsoft.Extensions.FileProviders.Abstractions.dll.so\00", align 1
@.DSOCacheEntry.31_name = private unnamed_addr constant [56 x i8] c"libaot-Microsoft.Extensions.Hosting.Abstractions.dll.so\00", align 1
...
@.DSOCacheEntry.42_name = private unnamed_addr constant [25 x i8] c"libaot-MySql.Data.dll.so\00", align 1
@.DSOCacheEntry.43_name = private unnamed_addr constant [29 x i8] c"libaot-MySqlConnector.dll.so\00", align 1
@.DSOCacheEntry.44_name = private unnamed_addr constant [47 x i8] c"libaot-Pomelo.EntityFrameworkCore.MySql.dll.so\00", align 1
...
@.DSOCacheEntry.47_name = private unnamed_addr constant [57 x i8] c"libaot-System.Security.Cryptography.ProtectedData.dll.so\00", align 1
@.DSOCacheEntry.48_name = private unnamed_addr constant [42 x i8] c"libaot-System.Security.Permissions.dll.so\00", align 1
...
@.DSOCacheEntry.83_name = private unnamed_addr constant [24 x i8] c"libaot-ZstdSharp.dll.so\00", align 1
@.DSOCacheEntry.84_name = private unnamed_addr constant [20 x i8] c"libaot-zxing.dll.so\00", align 1
@.DSOCacheEntry.85_name = private unnamed_addr constant [29 x i8] c"libaot-ZXing.Net.MAUI.dll.so\00", align 1
@.DSOCacheEntry.86_name = private unnamed_addr constant [38 x i8] c"libaot-ZXing.Net.MAUI.Controls.dll.so\00", align 1
@.DSOCacheEntry.87_name = private unnamed_addr constant [41 x i8] c"libaot-Microsoft.Win32.Primitives.dll.so\00", align 1
...
@.DSOCacheEntry.102_name = private unnamed_addr constant [57 x i8] c"libaot-System.Diagnostics.TextWriterTraceListener.dll.so\00", align 1
...
@.DSOCacheEntry.108_name = private unnamed_addr constant [43 x i8] c"libaot-System.IO.Compression.Brotli.dll.so\00", align 1
@.DSOCacheEntry.109_name = private unnamed_addr constant [36 x i8] c"libaot-System.IO.Compression.dll.so\00", align 1
@.DSOCacheEntry.110_name = private unnamed_addr constant [42 x i8] c"libaot-System.IO.MemoryMappedFiles.dll.so\00", align 1
@.DSOCacheEntry.111_name = private unnamed_addr constant [34 x i8] c"libaot-System.IO.Pipelines.dll.so\00", align 1
@.DSOCacheEntry.112_name = private unnamed_addr constant [30 x i8] c"libaot-System.IO.Pipes.dll.so\00", align 1
@.DSOCacheEntry.113_name = private unnamed_addr constant [38 x i8] c"libaot-System.Linq.Expressions.dll.so\00", align 1
@.DSOCacheEntry.114_name = private unnamed_addr constant [36 x i8] c"libaot-System.Linq.Queryable.dll.so\00", align 1
...
@.DSOCacheEntry.117_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Http.dll.so\00", align 1
@.DSOCacheEntry.118_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 1
...
@.DSOCacheEntry.121_name = private unnamed_addr constant [36 x i8] c"libaot-System.Net.Primitives.dll.so\00", align 1
@.DSOCacheEntry.122_name = private unnamed_addr constant [34 x i8] c"libaot-System.Net.Requests.dll.so\00", align 1
@.DSOCacheEntry.123_name = private unnamed_addr constant [34 x i8] c"libaot-System.Net.Security.dll.so\00", align 1
@.DSOCacheEntry.124_name = private unnamed_addr constant [33 x i8] c"libaot-System.Net.Sockets.dll.so\00", align 1
@.DSOCacheEntry.125_name = private unnamed_addr constant [35 x i8] c"libaot-System.Net.WebClient.dll.so\00", align 1
@.DSOCacheEntry.126_name = private unnamed_addr constant [45 x i8] c"libaot-System.Net.WebHeaderCollection.dll.so\00", align 1
@.DSOCacheEntry.127_name = private unnamed_addr constant [38 x i8] c"libaot-System.Numerics.Vectors.dll.so\00", align 1
@.DSOCacheEntry.128_name = private unnamed_addr constant [33 x i8] c"libaot-System.ObjectModel.dll.so\00", align 1
...
@.DSOCacheEntry.131_name = private unnamed_addr constant [53 x i8] c"libaot-System.Runtime.CompilerServices.Unsafe.dll.so\00", align 1
@.DSOCacheEntry.132_name = private unnamed_addr constant [45 x i8] c"libaot-System.Runtime.InteropServices.dll.so\00", align 1
@.DSOCacheEntry.133_name = private unnamed_addr constant [40 x i8] c"libaot-System.Runtime.Intrinsics.dll.so\00", align 1
...
@.DSOCacheEntry.137_name = private unnamed_addr constant [29 x i8] c"libaot-System.Runtime.dll.so\00", align 1
@.DSOCacheEntry.138_name = private unnamed_addr constant [37 x i8] c"libaot-System.Security.Claims.dll.so\00", align 1
@.DSOCacheEntry.139_name = private unnamed_addr constant [54 x i8] c"libaot-System.Security.Cryptography.Algorithms.dll.so\00", align 1
@.DSOCacheEntry.140_name = private unnamed_addr constant [47 x i8] c"libaot-System.Security.Cryptography.Csp.dll.so\00", align 1
@.DSOCacheEntry.141_name = private unnamed_addr constant [52 x i8] c"libaot-System.Security.Cryptography.Encoding.dll.so\00", align 1
@.DSOCacheEntry.142_name = private unnamed_addr constant [54 x i8] c"libaot-System.Security.Cryptography.Primitives.dll.so\00", align 1
@.DSOCacheEntry.143_name = private unnamed_addr constant [60 x i8] c"libaot-System.Security.Cryptography.X509Certificates.dll.so\00", align 1
@.DSOCacheEntry.144_name = private unnamed_addr constant [43 x i8] c"libaot-System.Security.Cryptography.dll.so\00", align 1
@.DSOCacheEntry.145_name = private unnamed_addr constant [48 x i8] c"libaot-System.Security.Principal.Windows.dll.so\00", align 1
@.DSOCacheEntry.146_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.Encoding.CodePages.dll.so\00", align 1
...
@.DSOCacheEntry.152_name = private unnamed_addr constant [38 x i8] c"libaot-System.Threading.Thread.dll.so\00", align 1
@.DSOCacheEntry.153_name = private unnamed_addr constant [42 x i8] c"libaot-System.Threading.ThreadPool.dll.so\00", align 1
@.DSOCacheEntry.154_name = private unnamed_addr constant [31 x i8] c"libaot-System.Threading.dll.so\00", align 1
@.DSOCacheEntry.155_name = private unnamed_addr constant [40 x i8] c"libaot-System.Transactions.Local.dll.so\00", align 1
